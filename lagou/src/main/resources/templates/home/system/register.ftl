...
<title>注册-兼职网-最专业的互联网招聘平台</title>
...
<body id="login_bg">
	<div class="login_wrapper">
		<div class="login_header">
        	<a href="/home/index/index"><img src="/home/style/images/logo_white.png" width="285" height="62" alt="兼职招聘" /></a>
		...
		<div class="login_box">
        	<form id="loginForm">
		        ...
		        <span for="type" generated="true" class="error" id="error_type" style="display:none">请勾选注册兼职网目的</span>
      ...
      $("#submitLogin").click(function() {
        	...
        	var data = $("#loginForm").serialize(); 
       		$.ajax({
				...
				success:function(data){
					if(data.code == 0){
						$("#successMsg").html("注册成功！快去登录体验兼职网叭！└(^o^)┘");
						$.colorbox({inline:true, href:$("#successTip"),title:"系统提示"});
					}else{
						switch(data.code){
							case -1010:
