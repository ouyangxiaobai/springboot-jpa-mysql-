...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2020, XXX, Ltd." />
<title>后台管理主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
    ...
    <div class="wu-main" data-options="region:'center'">
        <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            ...
            <div title="欢迎使用" style="padding:20px;overflow:hidden; color:red; " >
				...
				<p style="font-size: 25px; line-height: 30px; height: 30px;">欢迎使用兼职网后台管理系统</p>
			  	<p>开发人员：【XXX】</p>
			  	<p>开发周期：XXXXX</p>
				...
				<p>服务器：tomcat 8.5</p>
				<p>数据库：MySQL 5.7</p>
				<p>系统采用技术： spring+springMVC+JPA+EasyUI+jQuery+Ajax+面向接口编程</p>
			</div>
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2021 【兼职网】 All Rights Reserved
    </div>
    <!-- end of footer -->  
